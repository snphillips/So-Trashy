...
<img src="https://i.imgur.com/Zf8LOkR.png" width="300" alt="screen capture of app">
<img src="https://i.imgur.com/Ak3bbne.png" width="300" alt="screen capture of app">
<img src="https://i.imgur.com/Ak3bbne.png" width="300" alt="screen capture of app">
...
- to start the server:
  `$ npm start`
- open your browser to the ip address that Vite provides. Something like: http://localhost:5173/

## How to Update NPM Packages:

This app has many dependencies, so this will guide come in handy when they need updating:
...
- I check the app between every update by stopping then restart the server. If the app is still working, I move onto the next dependency.
